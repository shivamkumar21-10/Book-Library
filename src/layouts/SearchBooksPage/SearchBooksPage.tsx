...
export const SearchBooksPage = () => {
    ...
    const settingCategoryHandler = (value: string) => {
        setCurrentPage(1);
        if(
                        ...
                        <div className="col-4">
                            <div className="dropdown">
                                ...
                                <ul className="dropdown-menu" aria-labelledby="dropdownMenuButton1" >
                                    <li onClick={() => settingCategoryHandler('All')}>
                                        <a className="dropdown-item" href="#">
                                            All
                                        </a>
                                    </li>

                                    <li onClick={() => settingCategoryHandler('FE')}>
                                        <a className="dropdown-item" href="#" >
                                            Front End
                                        </a>
                                    </li>

                                    <li onClick={() => settingCategoryHandler('BE')}>
                                        <a className="dropdown-item" href="#" >
                                            Back End
                                        </a>
                                    </li>

                                    <li onClick={() => settingCategoryHandler('Data')}>
                                        <a className="dropdown-item" href="#" >
                                            Data
                                        </a>
                                    </li>

                                    <li onClick={() => settingCategoryHandler('DevOps')}>
                                        <a className="dropdown-item" href="#" >
                                            DevOps
                                        </a>
                                    </li>
